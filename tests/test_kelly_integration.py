...
def test_kelly_integration():
    ...
    try:
        ...
        backtester = BacktesterCore(
            initial_capital=10000, enable_kelly_position_sizing=True, kelly_fraction=0.5, max_position_pct=0.10
        )
        ...
        position_size = backtester._calculate_position_size(capital=10000, win_rate=0.6, win_loss_ratio=2.0)
