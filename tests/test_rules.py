...
def test_position_params_calculation(sample_data_perfect_long):
    ...
    params = calculate_position_params(
        df, idx=150, direction="long", capital=10000, risk_pct=0.01, max_exposure_pct=0.05
    )
...
def test_trailing_stop_activation():
    ...
    position = {"direction": "long", "entry_price": 45000, "stop_loss": 44775, "risk": 225, "trailing_active": False}
