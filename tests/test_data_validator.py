...
class TestDataValidator:
    ...
    def test_ohlc_valid(self):
        ...
        df = pd.DataFrame(
            {"open": [100, 101, 102], "high": [105, 106, 107], "low": [95, 96, 97], "close": [103, 104, 105]}
        )
    ...
    def test_time_gaps_detection(self):
        ...
        df = pd.DataFrame({"timestamp": timestamps, "open": [100, 101, 103, 104]})
    ...
    def test_duplicate_timestamps(self):
        ...
        df = pd.DataFrame({"timestamp": pd.to_datetime(timestamps), "open": [100, 101, 102]})
    ...
    def test_timezone_validation(self):
        ...
        df = pd.DataFrame({"timestamp": timestamps, "open": [100, 101, 102]})
    ...
    def test_large_dataset(self):
        ...
        df = pd.DataFrame({"timestamp": timestamps, "open": np.random.standard_normal(150000) + 100})
