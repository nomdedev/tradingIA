...
class MockEnsembleModel:
    ...
    def predict(self, X):
        ...
        return np.random.standard_normal((X.shape[0], 1))
...
class TestEnsembleModel:
    ...
    def sample_training_data(self):
        ...
        X = np.random.standard_normal((n_samples, lookback, n_features))

        # Generar targets (predicciones de precio)
        y = np.random.standard_normal((n_samples, 1)) + 100  # Precios alrededor de 100
    ...
    def sample_prediction_data(self):
        ...
        X = np.random.standard_normal((1, lookback, n_features))
        return X
    ...
    def test_scaler_functionality(self, ensemble_model):
        ...
        # Datos de prueba
        test_data = np.random.standard_normal((50, 8))
