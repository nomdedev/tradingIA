...
try:
    ...
    impact = model.calculate_impact(
        order_size=1.0, price=50000, avg_volume=0.0, volatility=0.02, bid_ask_spread=10  # Volumen cero!
    )
...
try:
    ...
    impact = model.calculate_impact(
        order_size=-1.0, price=50000, avg_volume=10.0, volatility=0.02, bid_ask_spread=10  # Negativo!
    )
...
try:
    ...
    impact = model.calculate_impact(
        order_size=1.0, price=0.0, avg_volume=10.0, volatility=0.02, bid_ask_spread=10  # Precio cero!
    )
...
try:
    ...
    impact_high = model.calculate_impact(
        order_size=1.0, price=50000, avg_volume=10.0, volatility=1.0, bid_ask_spread=10  # 100% volatilidad!
    )

    # Volatilidad normal
    impact_normal = model.calculate_impact(
        order_size=1.0, price=50000, avg_volume=10.0, volatility=0.02, bid_ask_spread=10  # 2% normal
    )
...
try:
    ...
    impact = model.calculate_impact(
        order_size=100.0, price=50000, avg_volume=10.0, volatility=0.02, bid_ask_spread=10  # 10x el volumen!
    )
