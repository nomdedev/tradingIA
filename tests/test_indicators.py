...
class TestIFVG:
    ...
    def test_ifvg_basic_calculation(self, sample_ohlcv_data):
        ...
        expected_cols = ["gap_up", "gap_down", "fvg_size", "ATR", "valid_fvg", "bull_signal", "bear_signal"]
...
class TestEMAs:
    ...
    def test_emas_trend_detection(self, trending_data):
        ...
        assert last_row["EMA_20"] > last_row["EMA_50"], "EMA20 debería estar sobre EMA50 en tendencia alcista"
...
class TestSignalGeneration:
    ...
    def test_generate_signals_with_filters(self, sample_ohlcv_data):
        ...
        # Sin filtros
        df1 = generate_signals(sample_ohlcv_data, use_ema_filter=False, use_vp_filter=False, use_volume_filter=False)
        signals1 = (df1["signal"] != 0).sum()

        # Con filtros
        df2 = generate_signals(sample_ohlcv_data, use_ema_filter=True, use_vp_filter=True, use_volume_filter=True)
    ...
    def test_generate_signals_confidence_correlation(self, sample_ohlcv_data):
        ...
        df = generate_signals(sample_ohlcv_data, use_ema_filter=True, use_vp_filter=True, use_volume_filter=True)
...
class TestCalculateAllIndicators:
    ...
    def test_calculate_all_has_all_indicators(self, sample_ohlcv_data):
        ...
        key_indicators = ["signal", "confidence", "POC", "EMA_20", "bull_signal", "bear_signal"]
