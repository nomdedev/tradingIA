...
class TestKellyPositionSizer:
    ...
    def test_position_size_calculation(self):
        ...
        result = sizer.calculate_position_size(capital=10000, win_rate=0.6, win_loss_ratio=2.0)
    ...
    def test_volatility_adjustment(self):
        ...
        result_high_vol = sizer.calculate_position_size(
            capital=10000, win_rate=0.6, win_loss_ratio=2.0, current_volatility=0.5  # High volatility
        )

        result_low_vol = sizer.calculate_position_size(
            capital=10000, win_rate=0.6, win_loss_ratio=2.0, current_volatility=0.0  # Low volatility
        )
    ...
    def test_market_impact_adjustment(self):
        ...
        result_no_impact = sizer.calculate_kelly_fraction(win_rate=0.6, win_loss_ratio=2.0, market_impact_pct=0.0)

        # With market impact
        result_with_impact = sizer.calculate_kelly_fraction(
            win_rate=0.6, win_loss_ratio=2.0, market_impact_pct=0.10  # 10% market impact
        )
    ...
    def test_bounds_enforcement(self):
        ...
        sizer = KellyPositionSizer(kelly_fraction=1.0, max_position_pct=0.05, min_position_pct=0.01)  # Max 5%  # Min 1%

        # Very aggressive Kelly (would be > 5%)
        result = sizer.calculate_position_size(
            capital=10000, win_rate=0.8, win_loss_ratio=3.0  # High win rate  # High reward
        )
    ...
    def test_risk_warnings(self):
        ...
        # High risk scenario
        result = sizer.calculate_kelly_fraction(win_rate=0.7, win_loss_ratio=4.0)  # Very high reward
