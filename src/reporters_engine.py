...
class ReportersEngine:
    ...
    def export_to_pine_script(self, strategy_name: str, params_dict: Dict[str, Any], output_file: str) -> bool:
...
"""
    ...
    def generate_pdf_report(
        self, title: str, metrics: Dict[str, Any], trades: List[Dict], charts_dict: Dict[str, Any], filename: str
    ) -> bool:
        ...
        try:
            ...
            if trades:
                ...
                for trade in recent_trades:
                    trades_data.append(
                        [str(trade.get("timestamp", ""))[:19], ".2f", ".2f", ".2f", str(trade.get("score", 0))]
                    )
