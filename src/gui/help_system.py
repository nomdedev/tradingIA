...
class HelpCenterDialog(QDialog):
    ...
    def get_help_content(self, topic):
        ...
        style = """
        <style>
            body { color: #cccccc; font-family: Segoe UI, Arial, sans-serif; font-size: 14px; background-color: #1e1e1e; }
            h1 { color: #4ec9b0; font-size: 24px; margin-bottom: 15px; }
            h2 { color: #569cd6; font-size: 18px; margin-top: 20px; margin-bottom: 10px; }
            h3 { color: #dcdcaa; font-size: 16px; margin-top: 15px; }
        ...
        content = content_map.get(topic, f"<h2>{topic}</h2><p>Contenido de ayuda para '{topic}' próximamente.</p>")
