...
def check_environment():
    ...
    dirs_to_check = ["data/raw", "data/cache", "config", "logs", "reports/sessions"]
...
def check_data_files():
    ...
    data_dirs = [project_root / "data" / "raw", project_root / "data" / "cache"]
...
def test_data_loading():
    ...
    try:
        ...
        result = dm.load_alpaca_data(
            symbol="BTC/USD", start_date="2024-01-01", end_date="2024-01-02", timeframe="1Hour"
        )
    ...
    try:
        ...
        df = fetcher.get_historical_data(
            symbol="BTC/USD", timeframe="1Hour", start_date="2024-01-01", end_date="2024-01-02"
        )
...
def generate_diagnostic_report():
    ...
    report = {
        ...
        "diagnostics": {"environment": {}, "data_files": {}, "loading_tests": {}, "logs": {}},
        "recommendations": [],
    }
