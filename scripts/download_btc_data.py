...
def download_btc_data(start_date, end_date, timeframe, output_dir="data/raw"):
    ...
    try:
        ...
        timeframe_map = {"5Min": "5m", "15Min": "15m", "1Hour": "1h", "4Hour": "4h"}
        ...
        if DATA_FETCHER_AVAILABLE and DataFetcher is not None:
            ...
            df = fetcher.get_historical_data(
                symbol="BTC/USD", timeframe=timeframe, start_date=start_date, end_date=end_date
            )
...
def main():
    ...
    parser.add_argument(
        "--timeframe", required=True, choices=["5Min", "15Min", "1Hour", "4Hour"], help="Timeframe to download"
    )

    args = parser.parse_args()

    success = download_btc_data(start_date=args.start_date, end_date=args.end_date, timeframe=args.timeframe)
