...
def diagnose_signals():
    ...
    buy_conditions = (
        potential_longs & (adx_trend_up | (df["adx"] < strategy.key_level)) & (wave_a_bullish | wave_b_bullish)
    )
    sell_conditions = (
        potential_shorts & (adx_trend_down | (df["adx"] < strategy.key_level)) & (wave_a_bearish | wave_b_bearish)
    )
