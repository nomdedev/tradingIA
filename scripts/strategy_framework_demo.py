...
import pandas as pd
import numpy as np
from core.strategies import StrategyRegistry, StrategyConfig, MomentumStrategy, MeanReversionStrategy, BreakoutStrategy
...
def demo_strategy_creation():
    ...
    momentum_config = StrategyConfig(
        ...
        parameters={"fast_period": 8, "slow_period": 21, "momentum_threshold": 0.025},
        risk_management={"max_drawdown_threshold": 0.15, "volatility_threshold": 0.03},
    ...
    mr_config = StrategyConfig(
        ...
        parameters={"lookback_period": 25, "entry_threshold": 1.8, "exit_threshold": 0.3},
        risk_management={"max_drawdown_threshold": 0.10},
