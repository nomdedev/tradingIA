...
def train_lstm_model(
    data_file: str, symbol: str = "BTCUSD", epochs: int = 50, sequence_length: int = 60, prediction_horizon: int = 5
):
...
def main():
    ...
    parser.add_argument("--data-file", type=str, default="data/btc_1H.csv", help="Path to historical data file")
    ...
    parser.add_argument("--prediction-horizon", type=int, default=5, help="Prediction horizon in bars")
