...
def run_backtest_with_parameter_saving():
    ...
    backtester = BacktesterCore(initial_capital=10000, commission=0.001, slippage_pct=0.0005)
    ...
    saved_file = save_backtest_results_with_parameters(result, strategy_class.__name__, "results/backtests")
