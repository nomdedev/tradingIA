...
class Tab0Dashboard(QWidget):
    ...
    def create_metrics_section(self):
        ...
        self.balance_card = MetricCard("Balance", "No Data", "Load backtest or start trading", "#4ec9b0")
        ...
        self.pnl_card = MetricCard("P&L", "No Data", "Run backtest to see results", "#569cd6")
        ...
        self.winrate_card = MetricCard("Win Rate", "No Data", "Execute trades to calculate", "#dcdcaa")
        self.winrate_card.setToolTip(
            "Percentage of profitable trades.\n" "Requires at least 10 completed trades to display."
        )

        self.trades_card = MetricCard("Trades", "0", "No active positions", "#c586c0")
    ...
    def add_activity(self, icon, message, activity_type="info"):
        ...
        colors = {"success": "#4ec9b0", "warning": "#dcdcaa", "error": "#f48771", "info": "#569cd6"}
