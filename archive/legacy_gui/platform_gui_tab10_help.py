...
from PySide6.QtWidgets import QWidget, QHBoxLayout, QTextBrowser, QSplitter, QTreeWidget, QTreeWidgetItem
...
class Tab10Help(QWidget):
    ...
    def create_help_structure(self, tree):
        ...
        categories = {
            ...
            "📊 Dashboard": ["Vista General", "Métricas del Sistema", "Acciones Rápidas", "Estado del Sistema"],
            "📥 Gestión de Datos": [
                "Descarga de Datos",
                "Formatos Soportados",
                "Almacenamiento",
            ...
            "⚙️ Estrategias": ["Configuración de Estrategias", "Parámetros", "Optimización", "Backtesting"],
            "▶️ Backtesting": [
