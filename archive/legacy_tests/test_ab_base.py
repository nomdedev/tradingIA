...
class TestABTestingBase:
    ...
    def setup_method(self):
        ...
        self.df_mock = pd.DataFrame(
            {
                "open": 45000 + np.random.standard_normal(1000).cumsum() * 10,
                "high": 45000 + np.random.standard_normal(1000).cumsum() * 10 + 50,
                "low": 45000 + np.random.standard_normal(1000).cumsum() * 10 - 50,
                "close": 45000 + np.random.standard_normal(1000).cumsum() * 10,
