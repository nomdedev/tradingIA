...
class TestAdvancedABTesting(unittest.TestCase):
    ...
    def test_comprehensive_ab_analysis(self):
        ...
        expected_sections = ["base_statistics", "robustness_metrics", "anti_snooping", "decision"]
        for section in expected_sections:
            self.assertIn(section, analysis)

    def test_advanced_decision_making(self):
        """Test advanced decision making logic"""
        base_stats = {"p_value": 0.03, "superiority_percentage": 0.15}

        robust_a = {"sortino_ratio": 1.2, "ulcer_index": 0.05, "probabilistic_sharpe": 0.6}

        robust_b = {"sortino_ratio": 1.5, "ulcer_index": 0.03, "probabilistic_sharpe": 0.7}
