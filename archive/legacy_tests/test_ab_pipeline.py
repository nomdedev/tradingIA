...
class TestABPipeline(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pipeline = ABPipeline(symbol="BTCUSD", start_date="2023-01-01", end_date="2023-01-10", capital=10000)
    ...
    def test_full_pipeline_success(self, mock_ab_class, mock_generate_signals, mock_fetch_data, mock_subprocess):
        ...
        mock_generate_signals.side_effect = [MagicMock(), MagicMock()]  # signals_a  # signals_b
        ...
        mock_protocol.comprehensive_ab_analysis.return_value = {
            ...
            "robustness_metrics": {"variant_a": {"sharpe_ratio": 1.2}, "variant_b": {"sharpe_ratio": 1.5}},
            "anti_snooping": {"overall_snooping_detected": False},
            "decision": {"recommendation": "ADOPT_B_STRONG", "reason": "B shows strong superiority", "confidence": 0.9},
        }
    ...
    def test_automated_decision_making(self):
        ...
        analysis = {"decision": {"recommendation": "ADOPT_B_STRONG", "confidence": 0.95}}
