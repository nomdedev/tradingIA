...
if __name__ == "__main__":
    ...
    df = pd.DataFrame({
        'open': np.random.standard_normal(100).cumsum() + 100,
        'high': np.random.standard_normal(100).cumsum() + 102,
        'low': np.random.standard_normal(100).cumsum() + 98,
        'close': np.random.standard_normal(100).cumsum() + 100,
