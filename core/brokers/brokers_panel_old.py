...
if PYQT6_AVAILABLE:
    ...
    class BrokerConfigDialog(QDialog):
        ...
        def __init__(self, parent=None, config: Optional[BrokerConfig] = None):
            ...
            self.config = config or BrokerConfig(name="", broker_type="alpaca", credentials={}, enabled=True)
...
class OrderDialog(QDialog):
    ...
    def _place_order(self):
        ...
        try:
            ...
            order = self.broker_manager.place_order(broker_name, symbol, side, quantity, order_type, **kwargs)
...
class BrokersPanel(QWidget):
    ...
    def _setup_status_table(self):
        ...
        self.status_table.setHorizontalHeaderLabels(["Broker", "Estado", "Posiciones", "Órdenes", "Tipo"])
    ...
    def _setup_positions_table(self):
        ...
        self.positions_table.setHorizontalHeaderLabels(
            ["Broker", "Símbolo", "Lado", "Cantidad", "Precio Promedio", "Precio Actual", "PnL No Realizado"]
        )
    ...
    def _setup_orders_table(self):
        ...
        self.orders_table.setHorizontalHeaderLabels(
            ["Broker", "ID", "Símbolo", "Lado", "Tipo", "Cantidad", "Precio", "Estado"]
        )
    ...
    def _cancel_selected_order(self):
        ...
        if broker_item and id_item:
            ...
            QMessageBox.information(
                self, "Función no implementada", "La cancelación de órdenes requiere el ID completo de la orden"
            )
