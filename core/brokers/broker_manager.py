...
class BrokerManager:
    ...
    def place_order(
        self, broker_name: str, symbol: str, side: str, quantity: float, order_type: str = "market", **kwargs
    ) -> Optional[Order]:
        ...
        try:
            ...
            order = broker.place_order(
                symbol=symbol, side=order_side, quantity=quantity, order_type=order_type_enum, **kwargs
            )
    ...
    def get_historical_data(
        self, broker_name: str, symbol: str, start_date: datetime, end_date: datetime, timeframe: str = "1D"
    ) -> Optional[Any]:
    ...
    def _save_config(self):
        ...
        try:
            ...
            data = {"brokers": [config.__dict__ for config in self.configs.values()]}
    ...
    def get_status_summary(self) -> Dict[str, Any]:
        ...
        for name, broker in self.brokers.items():
            broker_info = {"connected": broker.is_connected, "type": type(broker).__name__, "positions": 0, "orders": 0}
