    ...
    def run(self):
        ...
        try:
            ...
            for strategy in self.strategies:
                strategy_funcs.append(
                    lambda data, **params: strategy.generate_signals(strategy.calculate_indicators(data))
                )

            self.progress.emit(f"Running {len(strategy_funcs)} parallel backtests...")

            results = self.backtester.run_parallel_backtests(self.data, strategy_funcs[0], self.parameter_sets)
...
class DashboardController(QObject):
    ...
    def _load_strategies(self):
        ...
        try:
            from core.strategies import MomentumStrategy, MeanReversionStrategy, BreakoutStrategy
    ...
    def load_market_data(self, symbol: str = "BTC", timeframe: str = "1D", days: int = 365) -> bool:
        """
    ...
    def run_backtests(self, strategy_configs: List[Dict[str, Any]]) -> bool:
        ...
        try:
            ...
            self.backtest_worker = BacktestWorker(self.current_data, strategies, parameter_sets)
    ...
    def export_results(self, filepath: str) -> bool:
        ...
        try:
            ...
            for i, result in enumerate(self.backtest_results):
                row = {"backtest_id": i, "execution_time": result.execution_time, **result.metrics}
    ...
    def run_single_backtest(self, strategy_name: str, parameters: Dict[str, Any]) -> List[Any]:
        ...
        try:
            ...
            results = self.backtester.run_parallel_backtests(
                self.current_data, strategy_func, [parameters]  # Single parameter set
            )
