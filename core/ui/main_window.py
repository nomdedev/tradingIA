...
class MainWindow(QMainWindow):
    ...
    def load_market_data(self):
        ...
        filename, _ = QFileDialog.getOpenFileName(self, "Load Market Data", "", "CSV Files (*.csv);;All Files (*)")
    ...
    def load_strategy(self):
        ...
        filename, _ = QFileDialog.getOpenFileName(self, "Load Strategy", "", "Python Files (*.py);;All Files (*)")
    ...
    def show_documentation(self):
        ...
        QMessageBox.information(
            self, "Documentation", "Documentation is available in the 'docs/' folder of the project."
        )
