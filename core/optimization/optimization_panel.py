...
class OptimizationController(QObject):
    ...
    def add_strategy(self, strategy_name: str, strategy_class: Any, config: Optional[OptimizationConfig] = None):
...
class OptimizationPanel(QWidget):
    ...
    def setup_ui(self):
        ...
        self.fitness_combo.addItems(["sharpe_ratio", "total_return", "calmar_ratio", "sortino_ratio"])
        ...
        self.results_table.setHorizontalHeaderLabels(["Strategy", "Best Fitness", "Sharpe Ratio", "Total Return"])
