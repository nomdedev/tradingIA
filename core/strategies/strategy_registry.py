...
class StrategyRegistry:
    ...
    def register_strategy(self, strategy_class: Type[BaseStrategy], config_template: Optional[Dict[str, Any]] = None):
        """
    ...
    def get_strategy_info(self, name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            dummy_config = StrategyConfig(name=name, description="Dummy config for introspection", parameters={})
            ...
            # Strategy may not have get_required_parameters or may fail introspection
            required_params = []
...
def register_strategy(strategy_class: Type[BaseStrategy], config_template: Optional[Dict[str, Any]] = None):
